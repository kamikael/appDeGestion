...
return [
    ...
    | comme les règles de taille. N’hésitez pas à personnaliser chaque message
    ...
    */
    ...
    'uploaded' => 'Le champ :attribute a échoué lors du téléversement.',
    ...
    | pour des attributs en utilisant la convention "attribute.rule".
    | Cela permet de définir rapidement une ligne de langage spécifique.
    |
    */
    ...
    | d’attributs par quelque chose de plus lisible comme "Adresse e-mail"
    | au lieu de "email". Cela rend les messages plus expressifs.
    |
    */
